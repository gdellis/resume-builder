...
function ScrollBar({
  ...
  return (
    <ScrollAreaPrimitive.Scrollbar
      ...
      className={cn(
        "flex touch-none p-px transition-all duration-200 ease-out select-none",
    ...
    >
      <ScrollAreaPrimitive.Thumb
        ...
        className="relative flex-1 rounded-full bg-slate-400/70 hover:bg-slate-500 transition-colors duration-200"
      />
    </ScrollAreaPrimitive.Scrollbar>
  )
}
